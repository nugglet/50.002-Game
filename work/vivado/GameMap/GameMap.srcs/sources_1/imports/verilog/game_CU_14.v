...
module game_CU_14 (
  ...
  localparam CHECK_START_game_fsm = 6'd0;
  localparam BRANCH_CHECK_START_game_fsm = 6'd1;
  localparam SET_SCORE_game_fsm = 6'd2;
  localparam INITIALISE_GAME_TIMER_game_fsm = 6'd3;
  localparam INITIALISE_PLAYER_POSITION_game_fsm = 6'd4;
  localparam INITIALISE_MAP_COL_0_game_fsm = 6'd5;
  localparam INITIALISE_MAP_COL_1_game_fsm = 6'd6;
  localparam INITIALISE_MAP_COL_2_game_fsm = 6'd7;
  localparam INITIALISE_MAP_COL_3_game_fsm = 6'd8;
  localparam INITIALISE_MAP_COL_4_game_fsm = 6'd9;
  localparam INITIALISE_MAP_COL_5_game_fsm = 6'd10;
  localparam IDLE_game_fsm = 6'd11;
  localparam CHECK_LEFT_BOUNDARY_game_fsm = 6'd12;
  localparam BRANCH_LEFT_game_fsm = 6'd13;
  localparam SHIFT_PLAYER_LEFT_game_fsm = 6'd14;
  localparam CHECK_RIGHT_BOUNDARY_game_fsm = 6'd15;
  localparam BRANCH_RIGHT_game_fsm = 6'd16;
  localparam SHIFT_PLAYER_RIGHT_game_fsm = 6'd17;
  localparam CHECK_GAME_TIMER_game_fsm = 6'd18;
  localparam DECREASE_GAME_TIMER_game_fsm = 6'd19;
  localparam BRANCH_GAME_TIMER_game_fsm = 6'd20;
  localparam SHIFT_COL_0_game_fsm = 6'd21;
  localparam SHIFT_COL_1_game_fsm = 6'd22;
  localparam SHIFT_COL_2_game_fsm = 6'd23;
  localparam SHIFT_COL_3_game_fsm = 6'd24;
  localparam SHIFT_COL_4_game_fsm = 6'd25;
  localparam SHIFT_COL_5_game_fsm = 6'd26;
  localparam SHIFT_COLS_game_fsm = 6'd27;
  localparam GET_PLAYER_POS_game_fsm = 6'd28;
  localparam CHECK_PLAYER_POS_game_fsm = 6'd29;
  localparam CHECK_REMAINING_MAP_LENGTH_game_fsm = 6'd30;
  localparam BRANCH_MAPLENGTH_game_fsm = 6'd31;
  localparam INCREASE_SCORE_game_fsm = 6'd32;
  localparam CHECK_SCORE_game_fsm = 6'd33;
  localparam BRANCH_SCORE_game_fsm = 6'd34;
  localparam GAME_OVER_game_fsm = 6'd35;
  
  reg [5:0] M_game_fsm_d, M_game_fsm_q = CHECK_START_game_fsm;
  ...
  wire [1-1:0] M_time_detector_out;
  reg [1-1:0] M_time_detector_in;
  edge_detector_2 time_detector (
    .clk(clk),
    .in(M_time_detector_in),
    .out(M_time_detector_out)
  );
  ...
  always @* begin
    ...
    rb = 1'h0;
    rc = 11'h457;
    M_time_detector_in = M_slowclock_value;
    if (rst_button) begin
      M_game_fsm_d = CHECK_START_game_fsm;
    end
    
    case (M_game_fsm_q)
      CHECK_START_game_fsm: begin
        we = 1'h0;
        wdsel = 1'h0;
        asel = 1'h0;
        bsel = 4'ha;
        ...
        ra = 7'h6f;
        rc = 11'h457;
        M_game_fsm_d = BRANCH_CHECK_START_game_fsm;
      end
      BRANCH_CHECK_START_game_fsm: begin
        rb = 11'h457;
        if (~regfile_b[0+0-:1]) begin
          M_game_fsm_d = INITIALISE_GAME_TIMER_game_fsm;
        end else begin
      ...
      INITIALISE_GAME_TIMER_game_fsm: begin
        we = 1'h1;
        wdsel = 1'h0;
        asel = 4'hb;
        alufn = 14'h2b02;
        ...
        if (decrease_timer) begin
          ...
          if (left_button && ~right_button) begin
            ...
            if (right_button && ~left_button) begin
              ...
              M_game_fsm_d = CHECK_GAME_TIMER_game_fsm;
            end
          end
        end
      end
      ...
      CHECK_GAME_TIMER_game_fsm: begin
        we = 1'h1;
        wdsel = 1'h0;
        asel = 4'h0;
        bsel = 4'h2;
